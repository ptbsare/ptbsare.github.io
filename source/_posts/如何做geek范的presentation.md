...
![](如何做geek范的presentation/mdpress1.jpg)
...
![](如何做geek范的presentation/mdpress2.png)
...
![](如何做geek范的presentation/mdpress3.png)
...
### 第一个演示文档
新建first.md文件，写入以下内容
（书写格式为Markdown文本格式,Markdown基本规则格式请参照[此图](如何做geek范的presentation/mdpress4.png)）
```markdown
...
![](如何做geek范的presentation/mpress5.png)
## Metadata支持
支持Metadata的文本格式，例如：
```yaml
---
